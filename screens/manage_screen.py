...
class ManageScreen(Screen):
    ...
    def open_profile_window(self):
        ...
        self.display_name_input = TextInput(hint_text="Display Name", text=display_name or "", multiline=False)
        self.email_input = TextInput(hint_text="Email Address", text=email or "", multiline=False)
        self.new_password_input = TextInput(hint_text="New Password (optional)", password=True, multiline=False)
        ...
        btn_save = Button(text="Save Changes", background_color=(0.2,0.7,0.4,1), color=(1,1,1,1), bold=True)
        btn_cancel = Button(text="Cancel", background_color=(0.5,0.5,0.5,1), color=(1,1,1,1), bold=True)
